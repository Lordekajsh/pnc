...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'MERCADO PAGO EXEMPLO',                 -- Nome da lara
    lara_key TEXT DEFAULT '84463a8b-f52d-49dd-aa34-038b1bef4ea1',                                        -- Chave pix da lara
    main_img TEXT DEFAULT 'https://telegra.ph/file/f0ac7b4baf2ed34c51747.png',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@griomdz',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@mdzup',                                    -- Canal de notícias
    is_on INTEGER DEFAULT 1,                                                    -- Se o bot está on ou em manutenção
    gate_chk TEXT DEFAULT 'gatePladix',                                            -- Gate para chk
    gate_exchange TEXT DEFAULT 'gatePladix',                                       -- Gate para troca
...
if database_version == 0:
    cur.executescript(
        """
    ALTER TABLE bot_config ADD COLUMN gate_chk TEXT DEFAULT gatePladix;
    ALTER TABLE bot_config ADD COLUMN gate_exchange TEXT DEFAULT gatePladix;
        """
    )
